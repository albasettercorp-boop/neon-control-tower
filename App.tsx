          ...
          {activeView === 'dashboard' ? (
            <>
              <div className="shrink-0 space-y-3">
                ...
                <CampaignGoalWidget achieved={(currentClient as any)?.achieved || 0} goal={(currentClient as any)?.goal || 100} />
              </div>
        ...
        <TelegramSummaryModal
          ...
          leadData={{
            ...
            revenue:
              ...
              0,
            pain:
              ((sellers.find((s) => s.brand_name === telegramSummaryData.clientName) as any)?.pain_points || [])
