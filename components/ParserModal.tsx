                    ...
                    >
                        <div className="bg-slate-900 border border-white/10 rounded-2xl w-full max-w-md shadow-2xl">
                            ...
                            <form onSubmit={handleSubmit} className="p-6">
                                <div className="mb-5">
                                    <label className="block text-sm text-slate-400 mb-2">Поисковый запрос Wildberries</label>
                                    <input
                                        type="text"
                                        value={query}
                                ...
                                <div className="grid grid-cols-2 gap-4 mb-5">
                                    ...
                                    <div>
                                        <label className="block text-sm text-slate-400 mb-2">Макс. результатов</label>
                                        <input
                                            type="number"
                                            value={maxResults}
